...
# frob:waive WIRE001 reason="upgrade is invoked reflectively by Alembic's migration runner (command.upgrade), never through a static call site this gate can see" follow_up="T-0015"  # noqa: E501
def upgrade() -> None:
    """Upgrade schema: no-op baseline, nothing to create yet."""


# frob:doc docs/index.md#public-api
# frob:waive WIRE001 reason="downgrade is Alembic's own revert contract, invoked only by `alembic downgrade`, never by application code or this ticket's own test" follow_up="T-0015"  # noqa: E501
