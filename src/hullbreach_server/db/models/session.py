...
class _UTCDateTime(TypeDecorator):
    ...
    # frob:waive WIRE001 reason="called by SQLAlchemy's own result-loading machinery on every Session row read, never through a static call site this gate can see" follow_up="T-0026"  # noqa: E501
